...
<template>
  ...
  <el-sub-menu
    ...
    <el-menu-item-group
      ...
      <el-menu-item index="firm-list">
        ...
        <template #title>Check Balance</template>
      </el-menu-item>
      ...
      <el-menu-item index="create-firm">
        ...
        <template #title>Withdraw Cash</template>
      </el-menu-item>
  ...
  <el-sub-menu index="sub-3">
    ...
    <el-menu-item-group title="Customers">
  ...
  <el-sub-menu index="sub-4">
    ...
    <el-menu-item-group title="Tenders">
      <el-menu-item index="create-tender">
        <el-icon>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
          </svg>
        </el-icon>
        <template #title>Create Tender</template>
      </el-menu-item>
      <el-menu-item index="tender">
        <el-icon>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75" />
          </svg>
        </el-icon>
        <template #title>List Tenders</template>
      </el-menu-item>

    </el-menu-item-group>

  </el-sub-menu>
  <el-sub-menu index="sub-5">
    <template #title>
      <el-icon>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          <path stroke-linecap="round" stroke-linejoin="round" d="M11.35 3.836c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m8.9-4.414c.376.023.75.05 1.124.08 1.131.094 1.976 1.057 1.976 2.192V16.5A2.25 2.25 0 0 1 18 18.75h-2.25m-7.5-10.5H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V18.75m-7.5-10.5h6.375c.621 0 1.125.504 1.125 1.125v9.375m-8.25-3 1.5 1.5 3-3.75" />
    ...
    <el-menu-item-group title="Settings">
      <el-menu-item index="school">
        ...
        <template #title>School Details</template>
      </el-menu-item>
      <el-sub-menu index="sub-6">
        <template #title>
          <el-icon>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <el-menu-item-group title="Staff">
          <el-menu-item index="staff-list">
            ...
            <template #title>List Staff</template>
          </el-menu-item>
          <el-menu-item index="create-staff">
            <el-icon>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
              </svg>
            </el-icon>
            <template #title>Create Staff</template>
          </el-menu-item>
        </el-menu-item-group>
