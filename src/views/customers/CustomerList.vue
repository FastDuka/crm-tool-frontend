  ...
  >
    <template v-slot:bodyCell="slotProps">
      ...
      <template v-if="slotProps.column.key === 'actions'">
        <ElButton type="primary" link @click="goTo('customer-view', slotProps.text)" size="default" plain>
          View
          <span class="w-2"></span>
          <el-icon>
        ...
        <ElButton type="success" link @click="goTo('customer-download', slotProps.text)" size="default" plain>
          Download
          <span class="w-2"></span>
          <el-icon>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
