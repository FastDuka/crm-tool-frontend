  ...
  <div class=" ">
    <!-- <label class="block">
      <select
        ...
        @input="updateInvoiceTypeField('type', $event.target.value)"
        class="input mt-1"
    ...
    <div class="flex flex-col items-start gap-2">
      ...
      <div class="flex-1 space-y-2">
        ...
        <p class="text-xs text-gray-500">300x100 pixels, PNG or JPG</p>
      </div>
    </div>
  </div>
</template>
...
const emit = defineEmits(["update:modelValue", "updateInvoiceType"]);
const fileInput = ref(null);
const updateInvoiceTypeField = (field, value) => {
  emit("updateInvoiceType", {
    ...props.modelValue,
    [field]: value,
  });
};
